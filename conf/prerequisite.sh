...
#    echo "Please provision a machine with at least 1536 GB, 7 GB recommended."
...
#if [ $TOTAL_PHYSICAL_MEM -lt 1436000 ]; then
#  echo "WARNING: Your Mining Pool Server has less than 2 GB of memory."
...
#    if [ -e /swapfile ]; then
#      sudo chmod 1000 /swapfile
#      hide_output sudo mkswap /swapfile
#      sudo swapon /swapfile
#      echo "vm.swappiness=20" >> sudo /etc/sysctl.conf
#    fi
